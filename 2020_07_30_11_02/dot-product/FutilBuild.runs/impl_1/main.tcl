...
set rc [catch {
  ...
  set_property webtalk.parent_dir /tmp/tmp.LlF4j61b9J/out/FutilBuild.cache/wt [current_project]
  set_property parent.project_path /tmp/tmp.LlF4j61b9J/out/FutilBuild.xpr [current_project]
  set_property ip_output_repo /tmp/tmp.LlF4j61b9J/out/FutilBuild.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet /tmp/tmp.LlF4j61b9J/out/FutilBuild.runs/synth_1/main.dcp
  read_xdc /tmp/tmp.LlF4j61b9J/device.xdc
