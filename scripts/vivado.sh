...
synthesis_files="$script_dir/../synthesis_scripts"
futil_sources="$synthesis_files/device.xdc $synthesis_files/synth.tcl"
hls_sources="$synthesis_files/hls.tcl $synthesis_files/fxp_sqrt.h"
