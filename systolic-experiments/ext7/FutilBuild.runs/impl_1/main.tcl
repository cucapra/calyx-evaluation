...
set rc [catch {
  ...
  set_property ip_output_repo /tmp/tmp.LcemNdkKQ0/out/FutilBuild.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet /tmp/tmp.LcemNdkKQ0/out/FutilBuild.runs/synth_1/main.dcp
  read_xdc /tmp/tmp.LcemNdkKQ0/device.xdc
  link_design -top main -part xc7z020clg484-1 -mode out_of_context
