...
set rc [catch {
  ...
  set_property ip_output_repo /tmp/tmp.0LSlQATEwe/out/FutilBuild.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet /tmp/tmp.0LSlQATEwe/out/FutilBuild.runs/synth_1/main.dcp
